...
objDir = flowDir + "objects/" + args.platform + "/async_counter/"
...
shutil.copyfile(srcDir + "async_counter.v", flowDir + "design/src/async_counter/async_counter" + ".v")
shutil.copyfile(srcDir + "COMPARATOR.v", flowDir + "design/src/async_counter/COMPARATOR" + ".v")
shutil.copyfile(srcDir + "RING_OSCILLATOR.v", flowDir + "design/src/async_counter/RING_OSCILLATOR" + ".v")
...
shutil.copyfile(
    flowDir + "results/" + args.platform + "/async_count/6_final.gds",
    outputDir + "/" + designName + ".gds",
)
shutil.copyfile(
    flowDir + "results/" + args.platform + "/async_count/6_final.def",
    outputDir + "/" + designName + ".def",
)
shutil.copyfile(
    flowDir + "results/" + args.platform + "/async_count/6_final.v",
    outputDir + "/" + designName + ".v",
)
shutil.copyfile(
    flowDir + "results/" + args.platform + "/async_count/6_1_fill.sdc",
    outputDir + "/" + designName + ".sdc",
)

shutil.copyfile(
    flowDir + "reports/" + args.platform + "/async_count/6_final_drc.rpt",
