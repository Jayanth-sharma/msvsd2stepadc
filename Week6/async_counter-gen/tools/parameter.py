...
parser = argparse.ArgumentParser(description="ASYC_COUNTER design generator")
parser.add_argument(
    "--specfile",
    required=True,
...
if jsonSpec["generator"] != "async_counter-gen":
    print('Error: Generator specification must be "async_counter-gen".')
    sys.exit(1)
...
mFilePublic1 = genDir + args.platform + ".model_ASYC_COUNTER"
