...
C {devices/vsource.sym} 520 -80 0 0 {name=V1 value=0.1}
C {devices/vsource.sym} 630 -80 0 0 {name=V2 value=3.3}
C {devices/vsource.sym} 610 -220 0 0 {name=V4 value="pulse(0 1.8 0n 1p 1p 5u 10u)"}
C {devices/vsource.sym} 490 -220 0 0 {name=V5 value=3.3}
C {devices/vsource.sym} 730 -220 0 0 {name=V6 value="pulse(0 1.8 0ns 1p 1p 10u 20u)"}
C {devices/lab_pin.sym} 490 -290 2 0 {name=p16 sig_type=std_logic lab=vdd}
C {devices/lab_pin.sym} 620 -290 2 0 {name=p17 sig_type=std_logic lab=d0}
C {devices/lab_pin.sym} 730 -290 2 0 {name=p18 sig_type=std_logic lab=d1}
C {devices/gnd.sym} 610 -160 0 0 {name=l1 lab=GND}
C {devices/gnd.sym} 730 -160 0 0 {name=l2 lab=GND}
C {devices/gnd.sym} 490 -160 0 0 {name=l3 lab=GND}
C {devices/gnd.sym} 520 -20 0 0 {name=l4 lab=GND}
C {devices/gnd.sym} 630 -20 0 0 {name=l5 lab=GND}
C {devices/gnd.sym} 620 80 0 0 {name=l6 lab=GND}
C {devices/lab_pin.sym} 640 -140 2 0 {name=p19 sig_type=std_logic lab=inp1}
C {devices/lab_pin.sym} 520 -130 2 0 {name=p20 sig_type=std_logic lab=inp2}
...
C {switch.sym} 390 240 0 0 {name=x2}
C {switch.sym} 790 130 0 0 {name=x3}
